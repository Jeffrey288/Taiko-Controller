...
typedef struct {
	...
	uint16_t size_DeviceQualifierDesc;

} HID_ClassConfigStruct;


/* USB CUSTOM_HID device FS Configuration Descriptor */
extern uint8_t* USBD_CUSTOM_HID_CfgFSDesc;

/* USB CUSTOM_HID device HS Configuration Descriptor */
extern uint8_t* USBD_CUSTOM_HID_CfgHSDesc;

/* USB CUSTOM_HID device Other Speed Configuration Descriptor */
extern uint8_t* USBD_CUSTOM_HID_OtherSpeedCfgDesc;

/* USB CUSTOM_HID device Configuration Descriptor */
extern uint8_t* USBD_CUSTOM_HID_Desc;
...
// To simplify things, we assume that we only use
// one in and out endpoint.
