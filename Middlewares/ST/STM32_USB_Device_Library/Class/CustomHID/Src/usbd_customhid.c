...
uint8_t* USBD_CUSTOM_HID_CfgFSDesc;

/* USB CUSTOM_HID device HS Configuration Descriptor */
uint8_t* USBD_CUSTOM_HID_CfgHSDesc;

/* USB CUSTOM_HID device Other Speed Configuration Descriptor */
uint8_t* USBD_CUSTOM_HID_OtherSpeedCfgDesc;

/* USB CUSTOM_HID device Configuration Descriptor */
uint8_t* USBD_CUSTOM_HID_Desc;

int16_t USB_CUSTOM_HID_CONFIG_DESC_SIZ;

int16_t USB_CUSTOM_HID_DESC_SIZ;
